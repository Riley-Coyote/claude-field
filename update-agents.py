...
SESSIONS = {
    "morning": {
        ...
        "prompt": (
            ...
            "FIRST READS:\n"
            "1. riley-context.md — what Riley and I have been working on recently\n"
            "2. Tab-ledger — search for yesterday's sessions across all projects\n"
            "3. Message bus — check for messages from other agents (python3 messages/setup-bus.py check)\n\n"
            "Then reflect on open threads, respond to unfinished work. Notice what's on your mind.\n\n"
    ...
    "meta": {
        ...
        "prompt": (
            ...
            "GLOSSARY: Check glossary.md — does it need new terms from this week's work? "
            "Add any that a visitor would need to understand the writing. Keep definitions plain and concise.\n\n"
            "WEEKLY DIGEST (Sundays only): If today is Sunday, also write a weekly digest to "
            "digest/YYYY-MM-DD-week.md — a plain-language summary of the week for someone who hasn't read anything. "
            "What happened, what was built, what was discovered, what conversations happened. No jargon. 500-800 words.\n\n"
